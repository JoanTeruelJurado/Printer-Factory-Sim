...
| Simulation Dashboard | http://localhost:8002 | Switch to the **Sim Dashboard** tab for charts and scenario event overlays |
...
frontend/                   # React SPA (built output served by Manufacturer API)
  src/
    components/             # React components (GameHeader, tabs, modals)
      Tabs/
        SimDashboard.jsx    # Simulation Dashboard tab — charts and scenario event overlay
